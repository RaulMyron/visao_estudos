...
# save result
cv2.imwrite("./results/4cubes_thresh.jpg",thresh)
cv2.imwrite("./results/4cubes_clean.jpg",clean)
cv2.imwrite("./results/4cubes_result1.png",result1)
cv2.imwrite("./results/4cubes_result2.png",result2)
